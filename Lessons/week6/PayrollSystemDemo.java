...
public class PayrollSystemDemo {
    public static void main(String[] args) {
        ...
        payableList.add(new SalariedEmployee("John", "Doe", "111-11-1111", 800.00));
        payableList.add(new HourlyEmployee("Jane", "Smith", "222-22-2222", 16.75, 40));
        payableList.add(new CommissionEmployee("Bob", "Johnson", "333-33-3333", 10000, .06));
        ...
        for (Payable payable : payableList) {
            ...
            if (payable instanceof Employee) {
                Employee emp = (Employee) payable; // example with first employee
                System.out.println("Bonus for 1 month: " + emp.calculateBonus(emp.earnings()));
                System.out.println("Bonus for 3 months: " + emp.calculateBonus(emp.earnings(), 3));
            }
        }
    }
}